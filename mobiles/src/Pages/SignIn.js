...
const Client = () => {
  const [codeAccess, setCodeAccess] = React.useState('6870781');
  ...
  */
  ...
  return(
    ...
    >
      ...
      <TextInput style={styles.input} onChangeText={setCodeAccess} value={codeAccess} placeholderTextColor='#1c1c1c' placeholder="Nome"/>
