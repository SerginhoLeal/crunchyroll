  ...
  return(
    <View style={styles.body}>
      ...
      <View style={{padding:'15%',alignItems:'center'}}>
        ...
        <Text style={{fontSize:18, color:'#fff'}}>{data ? data.nome : "Seu Login"}</Text>
      </View>

      <TouchableOpacity style={styles.buttom} onPress={() => {props.navigation.navigate('Select')}}>
        {/* props para fazer a mudança de pagina */}
        <Text style={styles.txt}>Animes</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.buttom} onPress={() => {props.navigation.navigate('Criadores')}}>
        {/* <Icon name="briefcase" size={20} color="#fff" /> */}
        <Text style={styles.txt}>Criadores</Text>
      </TouchableOpacity>

      {
        ...
        <TouchableOpacity style={styles.buttom} onPress={() => {signOut()}}>
          ...
          :
        <TouchableOpacity style={styles.buttom} onPress={() => {props.navigation.navigate('SignIn')}}>
          {/* <Icon name="briefcase" size={20} color="#fff" /> */}
